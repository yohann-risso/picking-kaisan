...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    document
      ...
      ?.addEventListener("click", finalizarPicking);
    document
      .getElementById("btnConfirmarSKU")
      ?.addEventListener("click", biparProduto);
    ...
    document
      .getElementById("qtdCards")
      ?.addEventListener("input", atualizarQtdCards);
  } catch (e) {
